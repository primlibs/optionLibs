...
public final class Creator {
  ...
  public static final String MODELTABLE_OBJECT_NAME = "tableModelEnt";
  ...
  private Renderrable getPath(AbstractApplication app, String object, String action, String specAction, Map<String, Object> innerRequest, Render rd) {
    ...
    } else if (object.equals(MODELTABLE_OBJECT_NAME)) {
      return OptionAbstract.getModelTable(app, rd, action, specAction);
    } else {
